...
require (
	github.com/SENERGY-Platform/analytics-flow-repo-v2 v0.0.32
...
require (
	...
	github.com/SENERGY-Platform/analytics-operator-repo-v2 v0.0.7 // indirect
	...
	github.com/SENERGY-Platform/go-service-base/logger v1.0.0 // indirect
