...
func getKeycloakRouter() (router *httprouter.Router, err error) {
	defer func() {
	...
	router.HandlerFunc(http.MethodPost, "/auth/realms/master/protocol/openid-connect/token", func(writer http.ResponseWriter, request *http.Request) {
